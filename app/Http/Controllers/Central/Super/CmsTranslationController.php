...
class CmsTranslationController extends Controller
{
    ...
    protected array $sections = [
        ...
        'how_it_works'     => ['model' => LandingHowItWorksStep::class,  'label' => 'How It Works',     'mode' => 'multi'],
    ...
    public function index(Request $request): View
    {
        ...
        $locale = $request->get(
            'locale',
            $languages->firstWhere('is_default', false)?->locale ?? 'fr'
        );
        ...
        foreach ($this->sections as $key => $cfg) {
            ...
            if ($cfg['mode'] === 'single') {
                ...
                $sectionData[$key] = [
                    ...
                    'mode'   => 'single',
                    'items'  => $record
                        ? [['record' => $record, 'fields' => $record->getTranslatableFields()]]
                        : [],
                ];
            } else {
                ...
                foreach ($records as $r) {
                    $items[] = [
                        'record' => $r,
                        'fields' => $r->getTranslatableFields(),
                    ];
                }
        ...
        return view(
            'central.super.cms.translations',
            compact('languages', 'locale', 'sectionData')
        );
    }
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ...
            ->with(
                'success',
                __('super.cms_translations.saved', ['locale' => $locale])
            );
    }
}