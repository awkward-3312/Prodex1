    ...
    private function templates(): array
    {
        return [
            ...
            [
                ...
                'permissions' => ['dashboard', 'products_view', 'transfer_view', 'transfer_add', 'count_stock', 'stock_report', 'Warehouse_report'],
            ],
            [
                'key' => 'receiving_clerk',
                'name' => 'Encargado de recepción',
                'description' => 'Recibe compras y transferencias destinadas a su bodega.',
                'permissions' => ['dashboard', 'products_view', 'Purchases_view', 'transfer_view', 'transfer_edit', 'stock_report'],
            ],
            [
                'key' => 'inventory_manager',
                'name' => 'Encargado de inventario',
                'description' => 'Gestiona existencias, conteos, ajustes y transferencias dentro de su alcance.',
                'permissions' => ['dashboard', 'products_view', 'products_add', 'products_edit', 'transfer_view', 'transfer_add', 'transfer_edit', 'adjustment_view', 'adjustment_add', 'adjustment_edit', 'count_stock', 'stock_report', 'Warehouse_report', 'inventory_valuation'],
            ],
            [
                'key' => 'sales_rep',
                'name' => 'Vendedor',
            ...
            [
                ...
                'permissions' => ['dashboard', 'Sales_view', 'Purchases_view', 'products_view', 'Customers_view', 'Suppliers_view', 'transfer_view', 'stock_report', 'Warehouse_report', 'Reports_sales', 'Reports_purchase', 'Reports_profit', 'view_employee', 'attendance', 'branches_view'],
            ],
            [
                'key' => 'branch_admin',
                'name' => 'Administrador de sucursal',
                'description' => 'Administra la operación diaria de la sucursal con alcance limitado.',
                'permissions' => ['dashboard', 'Sales_view', 'Sales_add', 'Purchases_view', 'Purchases_add', 'products_view', 'products_edit', 'Customers_view', 'Customers_add', 'Suppliers_view', 'Suppliers_add', 'transfer_view', 'transfer_add', 'stock_report', 'view_employee', 'attendance', 'branches_view'],
            ],
            [
