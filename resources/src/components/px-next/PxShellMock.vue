  ...
  <div class="pxn-shell" role="img" aria-label="Maqueta visual del shell de PRODEX (hipótesis, no navegable)">
    ...
    <nav class="pxn-shell__rail" aria-hidden="true">
      ...
      <div class="pxn-shell__rail-foot">
        <span class="pxn-shell__module"><lucide-icon name="life-buoy" :size="17" /></span>
        <span class="pxn-shell__module"><lucide-icon name="settings" :size="17" /></span>
      </div>
    </nav>

    <!-- optional context panel -->
    <aside v-if="showPanel" class="pxn-shell__panel" aria-hidden="true">
...
/* panel */
.pxn-shell__panel { width: 208px; background: var(--pxn-surface); border-right: 1px solid var(--pxn-border); padding: var(--pxn-space-5); }
