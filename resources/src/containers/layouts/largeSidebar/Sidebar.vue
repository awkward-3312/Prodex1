      ...
      <div>
        <ul class="navigation-left">
         ...
         <li
          ...
          >
            <router-link tag="a" class="nav-item-hold" to="/app/promotions">
          ...
          >
            <router-link tag="a" class="nav-item-hold" to="/app/shopify">
    ...
    >
      ...
      <!-- marketing -->
        ...
        >
          ...
          >
            <router-link tag="a" class to="/app/settings/zatca_settings">
