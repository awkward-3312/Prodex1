  ...
  >
      ...
      <div>
        <ul class="navigation-left">
          <li
            ...
            data-item="dashboard"
          >
            <router-link class="nav-item-hold" to="/app/dashboard" :class="{ open: routeIncludes('/app/dashboard') }">
          ...
          <li
            ...
            data-item="support"
          >
            <router-link class="nav-item-hold" to="/app/support/tickets" :class="{ open: routeIncludes('/app/support/tickets') }">
         ...
         <li
          ...
          <li
            v-show="planFeature('promotions') && currentUserPermissions && currentUserPermissions.includes('promotion')"
            class="nav-item"
            :class="{ active: $route.path === '/app/promotions' }"
          >
            <router-link class="nav-item-hold" to="/app/promotions" :class="{ open: routeIncludes('/app/promotions') }">
              <lucide-icon class="nav-icon" name="tag" />
              <span class="nav-text">{{ $t('Promotions') || 'Promotions' }}</span>
            </router-link>
            <div class="triangle"></div>
          </li>
          ...
          >
           ...
           <router-link class="nav-item-hold" to="/app/sale_return/list" :class="{ open: routeIncludes('/app/sale_return/list') }">
          ...
          <li
            v-show="planFeature('quotations') && currentUserPermissions && (currentUserPermissions.includes('Quotations_view')
          ...
          >
          <router-link class="nav-item-hold" to="/app/purchase_return/list" :class="{ open: routeIncludes('/app/purchase_return/list') }">
          ...
          <li
            v-show="planFeature('recruitment') && currentUserPermissions && (currentUserPermissions.includes('recruit_job')
          ...
          <li
            v-show="planFeature('meetings') && currentUserPermissions && (currentUserPermissions.includes('meeting')
          ...
          <li
            v-show="planFeature('marketing') && currentUserPermissions && (currentUserPermissions.includes('marketing_dashboard')
          ...
          >
           ...
           <router-link class="nav-item-hold" to="/app/subscription_product/list" :class="{ open: routeIncludes('/app/subscription_product/list') }">
          ...
          <li
            v-show="planFeature('assets') && currentUserPermissions && currentUserPermissions.includes('assets')"
            @mouseenter="toggleSubMenu"
          ...
          <li
            v-show="planFeature('projects') && currentUserPermissions && currentUserPermissions.includes('projects')"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'projects' }"
            class="nav-item"
            data-item="projects"
          >
            <router-link class="nav-item-hold" to="/app/projects" :class="{ open: routeIncludes('/app/projects') }">
          ...
          <li
            v-show="planFeature('contracts') && currentUserPermissions && currentUserPermissions.includes('contracts')"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'contracts' }"
            class="nav-item"
            data-item="contracts"
          >
            <router-link class="nav-item-hold" to="/app/contracts" :class="{ open: routeIncludes('/app/contracts') }">
          ...
          <li
            v-show="planFeature('projects') && currentUserPermissions && currentUserPermissions.includes('tasks')"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'tasks' }"
            class="nav-item"
            data-item="tasks"
          >
            <router-link class="nav-item-hold" to="/app/tasks" :class="{ open: routeIncludes('/app/tasks') }">
          ...
          <li
            v-show="planFeature('bookings') && currentUserPermissions && currentUserPermissions.includes('bookings')"
            @mouseenter="toggleSubMenu"
          ...
          <!-- Commissions -->
          <li
            v-show="planFeature('commissions') && currentUserPermissions && currentUserPermissions.includes('commissions_view')"
            @mouseenter="toggleSubMenu"
          ...
          >
            <router-link class="nav-item-hold" to="/app/woocommerce" :class="{ open: routeIncludes('/app/woocommerce') }">
              <lucide-icon class="nav-icon" name="shopping-cart" />
          ...
          <!-- shopify_settings -->
          <li
            v-show="planFeature('shopify') && currentUserPermissions && currentUserPermissions.includes('shopify_settings')"
            :class="{ active: selectedParentMenu == 'shopify_settings' }"
            class="nav-item"
            data-item="shopify_settings"
          >
            <router-link class="nav-item-hold" to="/app/shopify" :class="{ open: routeIncludes('/app/shopify') }">
              <lucide-icon class="nav-icon" name="store" />
              <span class="nav-text">{{$t('Shopify_Settings')}}</span>
            </router-link>
          </li>

          <!-- Knowledge Base -->
          <li
            v-show="planFeature('knowledge_base') && currentUserPermissions && currentUserPermissions.includes('knowledge_base_view')"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'knowledge-base' }"
            class="nav-item"
            data-item="knowledge-base"
          >
            <router-link class="nav-item-hold" to="/app/knowledge-base" :class="{ open: routeIncludes('/app/knowledge-base') }">
          ...
          <li
            v-show="currentUserPermissions && (currentUserPermissions.includes('setting_system')
                        ...
                        || currentUserPermissions.includes('zatca_settings')
          ...
          >
            <router-link class="nav-item-hold" to="/app/reports/ai_reports" :class="{ open: routeIncludes('/app/reports/ai_reports') }">
    ...
    >
      ...
      >
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Settings" :class="{ open: routeIncludes('/app/Store/Settings') }">
            <lucide-icon class="nav-icon" name="settings" />
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Orders" :class="{ open: routeIncludes('/app/Store/Orders') }">
            <lucide-icon class="nav-icon" name="receipt" />
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Collections" :class="{ open: routeIncludes('/app/Store/Collections') }">
            <lucide-icon class="nav-icon" name="check" />
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Banners" :class="{ open: routeIncludes('/app/Store/Banners') }">
            <lucide-icon class="nav-icon" name="wallet" />
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Subscribers" :class="{ open: routeIncludes('/app/Store/Subscribers') }">
            <lucide-icon class="nav-icon" name="users" />
        ...
        >
          <router-link class="nav-item-hold" to="/app/Store/Messages" :class="{ open: routeIncludes('/app/Store/Messages') }">
        ...
        <li
          ...
          v-if="currentUserPermissions && currentUserPermissions.includes('Store_settings_view')"
        >
          <router-link class="nav-item-hold" to="/app/Store/InviteCodes" :class="{ open: routeIncludes('/app/Store/InviteCodes') }">
        ...
        <li
          ...
          v-if="currentUserPermissions && currentUserPermissions.includes('Store_settings_view')"
        >
          <router-link class="nav-item-hold" to="/app/Store/PendingCustomers" :class="{ open: routeIncludes('/app/Store/PendingCustomers') }">
        ...
        >
          ...
          <ul v-show="realEstateOpen" class="childNav-sub" style="list-style:none;margin:0;padding-left:16px;">
            <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('realestate_properties')">
              <router-link class="nav-item-hold" to="/app/realestate/properties" :class="{ open: routeIncludes('/app/realestate/properties') }">
                <lucide-icon class="nav-icon" name="building" />
            ...
            <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('realestate_categories')">
              <router-link class="nav-item-hold" to="/app/realestate/categories" :class="{ open: routeIncludes('/app/realestate/categories') }">
                <lucide-icon class="nav-icon" name="tag" />
            ...
            <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('realestate_inquiries')">
              <router-link class="nav-item-hold" to="/app/realestate/inquiries" :class="{ open: routeIncludes('/app/realestate/inquiries') }">
        ...
        >
          ...
          >
            <router-link class to="/app/products/store" :class="{ open: routeIncludes('/app/products/store') }">
          ...
          >
            <router-link class to="/app/products/list" :class="{ open: routeIncludes('/app/products/list') }">
          ...
          >
            <router-link class to="/app/products/import" :class="{ open: routeIncludes('/app/products/import') }">
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('product_import')"
          >
            <router-link class to="/app/products/import-update" :class="{ open: routeIncludes('/app/products/import-update') }">
          ...
          >
            <router-link class to="/app/products/opening_stock_import" :class="{ open: routeIncludes('/app/products/opening_stock_import') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/products/barcode" :class="{ open: routeIncludes('/app/products/barcode') }">
          ...
          >
            <router-link class to="/app/products/count_stock" :class="{ open: routeIncludes('/app/products/count_stock') }">
          ...
          >
            <router-link class to="/app/products/Categories" :class="{ open: routeIncludes('/app/products/Categories') }">
          ...
          >
            <router-link class to="/app/products/SubCategories" :class="{ open: routeIncludes('/app/products/SubCategories') }">
              <lucide-icon class="nav-icon" name="library" />
          ...
          >
            <router-link class to="/app/products/Brands" :class="{ open: routeIncludes('/app/products/Brands') }">
          ...
          >
            <router-link class to="/app/products/Units" :class="{ open: routeIncludes('/app/products/Units') }">
          ...
          >
            <router-link class to="/app/products/Batches" :class="{ open: routeIncludes('/app/products/Batches') }">
          ...
          >
            <router-link class to="/app/serial_numbers/list" :class="{ open: routeIncludes('/app/serial_numbers/list') }">
        ...
        >
          ...
          >
            <router-link class to="/app/finance/sar_fiscal" :class="{ open: routeIncludes('/app/finance/sar_fiscal') }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('accounting_dashboard')">
            <router-link class to="/app/accounting-v2/dashboard" :class="{ open: routeIncludes('/app/accounting-v2/dashboard') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('chart_of_accounts')">
            <router-link class to="/app/accounting-v2/chart-of-accounts" :class="{ open: routeIncludes('/app/accounting-v2/chart-of-accounts') }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('journal_entries')">
            <router-link class to="/app/accounting-v2/journal-entries" :class="{ open: routeIncludes('/app/accounting-v2/journal-entries') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('trial_balance')">
            <router-link class to="/app/accounting-v2/reports/trial-balance" :class="{ open: routeIncludes('/app/accounting-v2/reports/trial-balance') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('accounting_profit_loss')">
            <router-link class to="/app/accounting-v2/reports/profit-and-loss" :class="{ open: routeIncludes('/app/accounting-v2/reports/profit-and-loss') }">
              <lucide-icon class="nav-icon" name="wallet" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('balance_sheet')">
            <router-link class to="/app/accounting-v2/reports/balance-sheet" :class="{ open: routeIncludes('/app/accounting-v2/reports/balance-sheet') }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('accounting_tax_report')">
            <router-link class to="/app/accounting-v2/reports/tax-report" :class="{ open: routeIncludes('/app/accounting-v2/reports/tax-report') }">
              <lucide-icon class="nav-icon" name="files" />
        ...
        >
          ...
          >
            <router-link class to="/app/adjustments/store" :class="{ open: routeIncludes('/app/adjustments/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/adjustments/list" :class="{ open: routeIncludes('/app/adjustments/list') }">
              <lucide-icon class="nav-icon" name="files" />
        ...
        >
          ...
          >
            <router-link class to="/app/transfers/store" :class="{ open: routeIncludes('/app/transfers/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/transfers/list" :class="{ open: routeIncludes('/app/transfers/list') }">
              <lucide-icon class="nav-icon" name="files" />
        ...
        >
          ...
          >
            <router-link class to="/app/damages/store" :class="{ open: routeIncludes('/app/damages/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('damage_view')"
          >
            <router-link class to="/app/damages/list" :class="{ open: routeIncludes('/app/damages/list') }">
              <lucide-icon class="nav-icon" name="files" />
        ...
        <li
          ...
          >
            <router-link class to="/app/accounts" :class="{ open: routeIncludes('/app/accounts') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/transfer_money" :class="{ open: routeIncludes('/app/transfer_money') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/expenses/store" :class="{ open: routeIncludes('/app/expenses/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/expenses/list" :class="{ open: routeIncludes('/app/expenses/list') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/deposits/store" :class="{ open: routeIncludes('/app/deposits/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/deposits/list" :class="{ open: routeIncludes('/app/deposits/list') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('expense_view')"
          >
            <router-link class to="/app/expenses/category" :class="{ open: routeIncludes('/app/expenses/category') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('deposit_view')"
          >
            <router-link class to="/app/deposits/category" :class="{ open: routeIncludes('/app/deposits/category') }">
              <lucide-icon class="nav-icon" name="files" />
        ...
        >
          ...
          >
            <router-link class to="/app/purchases/store" :class="{ open: routeIncludes('/app/purchases/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/purchases/list" :class="{ open: routeIncludes('/app/purchases/list') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('Purchases_add')"
          >
            <router-link class to="/app/purchases/import_purchases" :class="{ open: routeIncludes('/app/purchases/import_purchases') }">
              <lucide-icon class="nav-icon" name="file-plus" />
        ...
        >
          <li class="nav-item">
            <router-link class to="/app/service/jobs" :class="{ open: routeIncludes('/app/service/jobs') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li class="nav-item">
            <router-link class to="/app/service/technicians" :class="{ open: routeIncludes('/app/service/technicians') }">
              <lucide-icon class="nav-icon" name="files" />
              <span class="item-name">{{$t('Service_Technicians')}}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class to="/app/service/checklist-categories" :class="{ open: routeIncludes('/app/service/checklist-categories') }">
              <lucide-icon class="nav-icon" name="folder" />
              <span class="item-name">{{$t('Checklist_Categories')}}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class to="/app/service/checklists" :class="{ open: routeIncludes('/app/service/checklists') }">
              <lucide-icon class="nav-icon" name="check" />
              <span class="item-name">{{$t('Checklist_Items')}}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class to="/app/service/history" :class="{ open: routeIncludes('/app/service/history') }">
              <lucide-icon class="nav-icon" name="calendar-days" />
        ...
        >
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('assets')">
            <router-link class to="/app/assets/store" :class="{ open: routeIncludes('/app/assets/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
              <span class="item-name">{{$t('Add_Asset')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('assets')">
            <router-link class to="/app/assets/list" :class="{ open: routeIncludes('/app/assets/list') }">
              <lucide-icon class="nav-icon" name="files" />
              <span class="item-name">{{$t('Assets_List')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('assets')">
            <router-link class to="/app/assets/due" :class="{ open: routeIncludes('/app/assets/due') }">
              <lucide-icon class="nav-icon" name="clock" />
              <span class="item-name">{{$t('Due_Assets')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('assets')">
            <router-link class to="/app/assets/category" :class="{ open: routeIncludes('/app/assets/category') }">
              <lucide-icon class="nav-icon" name="folder" />
        ...
        >
          ...
          >
            <router-link class to="/app/sales/import_sales" :class="{ open: routeIncludes('/app/sales/import_sales') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/sales/list" :class="{ open: routeIncludes('/app/sales/list') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/pos" :class="{ open: routeIncludes('/app/pos') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/customer-display/setup" :class="{ open: routeIncludes('/app/customer-display/setup') }">
              <lucide-icon class="nav-icon" name="barcode" />
          ...
          >
            <router-link class to="/app/sales/shipment" :class="{ open: routeIncludes('/app/sales/shipment') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          >
            <router-link class to="/app/real-time-sales-counter" :class="{ open: routeIncludes('/app/real-time-sales-counter') }">
              <lucide-icon class="nav-icon" name="shopping-cart" />
        ...
        >
          ...
          >
            <router-link class to="/app/bookings/list" :class="{ open: routeIncludes('/app/bookings/list') }">
              <lucide-icon class="nav-icon" name="files" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('bookings')"
          >
            <router-link class to="/app/bookings/calendar" :class="{ open: routeIncludes('/app/bookings/calendar') }">
              <lucide-icon class="nav-icon" name="calendar-days" />
        ...
        >
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('commissions_view')">
            <router-link class to="/app/commissions/programs" :class="{ open: routeIncludes('/app/commissions/programs') }">
              <lucide-icon class="nav-icon" name="files" />
              <span class="item-name">{{ $t('Commission_Programs') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('commissions_view')">
            <router-link class to="/app/commissions/agents" :class="{ open: routeIncludes('/app/commissions/agents') }">
              <lucide-icon class="nav-icon" name="users" />
              <span class="item-name">{{ $t('Sales_Agents') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('commissions_view')">
            <router-link class to="/app/commissions/rules" :class="{ open: routeIncludes('/app/commissions/rules') }">
              <lucide-icon class="nav-icon" name="settings" />
              <span class="item-name">{{ $t('Commission_Rules') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('commissions_view')">
            <router-link class to="/app/commissions/receipts" :class="{ open: routeIncludes('/app/commissions/receipts') }">
              <lucide-icon class="nav-icon" name="receipt" />
              <span class="item-name">{{ $t('Commission_Receipts') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('commissions_view')">
            <router-link class to="/app/commissions/report" :class="{ open: routeIncludes('/app/commissions/report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
        ...
        >
          ...
          >
            <router-link class to="/app/quotations/store" :class="{ open: routeIncludes('/app/quotations/store') }">
              <lucide-icon class="nav-icon" name="file-plus" />
          ...
          >
            <router-link class to="/app/quotations/list" :class="{ open: routeIncludes('/app/quotations/list') }">
              <lucide-icon class="nav-icon" name="files" />
      ...
      <!-- hrm -->
        ...
        >
         <li
          ...
          >
            <router-link class to="/app/hrm/company" :class="{ open: routeIncludes('/app/hrm/company') }">
          ...
          >
            <router-link class to="/app/hrm/departments" :class="{ open: routeIncludes('/app/hrm/departments') }">
              <lucide-icon class="nav-icon" name="store" />
          ...
          >
            <router-link class to="/app/hrm/designations" :class="{ open: routeIncludes('/app/hrm/designations') }">
          ...
          >
            <router-link class to="/app/hrm/office_Shift" :class="{ open: routeIncludes('/app/hrm/office_Shift') }">
              <lucide-icon class="nav-icon" name="clock" />
          ...
          >
            <router-link class to="/app/hrm/employees" :class="{ open: routeIncludes('/app/hrm/employees') }">
              <lucide-icon class="nav-icon" name="wrench" />
          ...
          >
            <router-link class to="/app/hrm/attendance" :class="{ open: routeIncludes('/app/hrm/attendance') }">
              <lucide-icon class="nav-icon" name="clock" />
          ...
          >
            ...
            <ul class="submenu">
              <li
              >
                <router-link class to="/app/hrm/leaves/list" :class="{ open: routeIncludes('/app/hrm/leaves/list') }">
              ...
              <li
              >
                <router-link class to="/app/hrm/leaves/type" :class="{ open: routeIncludes('/app/hrm/leaves/type') }">
                  <lucide-icon class="nav-icon" name="id-card" />
          ...
          >
            <router-link class to="/app/hrm/holidays" :class="{ open: routeIncludes('/app/hrm/holidays') }">
          ...
          >
            <router-link class to="/app/hrm/payrolls" :class="{ open: routeIncludes('/app/hrm/payrolls') }">
              <lucide-icon class="nav-icon" name="banknote" />
      ...
      <!-- recruit -->
        ...
        >
          ...
          >
            <router-link class to="/app/recruit/dashboard" :class="{ open: routeIncludes('/app/recruit/dashboard') }">
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('recruit_job')"
          >
            <router-link class to="/app/recruit/jobs" :class="{ open: routeIncludes('/app/recruit/jobs') }">
              <lucide-icon class="nav-icon" name="briefcase-business" />
          ...
          >
            <router-link class to="/app/recruit/candidates" :class="{ open: routeIncludes('/app/recruit/candidates') }">
          ...
          >
            <router-link class to="/app/recruit/applications" :class="{ open: routeIncludes('/app/recruit/applications') }">
              <lucide-icon class="nav-icon" name="file-text" />
          ...
          >
            <router-link class to="/app/recruit/interviews" :class="{ open: routeIncludes('/app/recruit/interviews') }">
              <lucide-icon class="nav-icon" name="calendar" />
          ...
          >
            <router-link class to="/app/recruit/categories" :class="{ open: routeIncludes('/app/recruit/categories') }">
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('recruit_job')"
          >
            <router-link class to="/app/recruit/reports" :class="{ open: routeIncludes('/app/recruit/reports') }">
      ...
      <!-- meeting -->
        ...
        >
          ...
          >
            <router-link class to="/app/meeting/dashboard" :class="{ open: routeIncludes('/app/meeting/dashboard') }">
              <lucide-icon class="nav-icon" name="layout-dashboard" />
              <span class="item-name">{{$t('Dashboard')}}</span>
            </router-link>
          </li>
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('meeting')"
          >
            <router-link class to="/app/meeting/meetings" :class="{ open: routeIncludes('/app/meeting/meetings') }">
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('meeting')"
          >
            <router-link class to="/app/meeting/calendar" :class="{ open: routeIncludes('/app/meeting/calendar') }">
              <lucide-icon class="nav-icon" name="calendar" />
          ...
          >
            <router-link class to="/app/meeting/reports" :class="{ open: routeIncludes('/app/meeting/reports') }">
              <lucide-icon class="nav-icon" name="bar-chart-3" />
              <span class="item-name">{{$t('Reports')}}</span>
            </router-link>
          </li>
      ...
      <!-- marketing -->
        ...
        >
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_dashboard')">
            <router-link class to="/app/marketing/dashboard" :class="{ open: routeIncludes('/app/marketing/dashboard') }">
              <lucide-icon class="nav-icon" name="layout-dashboard" />
              <span class="item-name">{{$t('Dashboard')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_campaigns')">
            <router-link class to="/app/marketing/campaigns" :class="{ open: routeIncludes('/app/marketing/campaigns') }">
              <lucide-icon class="nav-icon" name="megaphone" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_segments')">
            <router-link class to="/app/marketing/segments" :class="{ open: routeIncludes('/app/marketing/segments') }">
              <lucide-icon class="nav-icon" name="users" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
            <router-link class to="/app/marketing/templates/sms" :class="{ open: routeIncludes('/app/marketing/templates/sms') }">
              <lucide-icon class="nav-icon" name="message-square" />
              <span class="item-name">{{$t('sms_templates')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
            <router-link class to="/app/marketing/templates/whatsapp" :class="{ open: routeIncludes('/app/marketing/templates/whatsapp') }">
              <lucide-icon class="nav-icon" name="message-circle" />
              <span class="item-name">{{$t('WhatsApp_Templates')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_templates')">
            <router-link class to="/app/marketing/templates/email" :class="{ open: routeIncludes('/app/marketing/templates/email') }">
              <lucide-icon class="nav-icon" name="mail" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_reports')">
            <router-link class to="/app/marketing/reports" :class="{ open: routeIncludes('/app/marketing/reports') }">
              <lucide-icon class="nav-icon" name="bar-chart-3" />
              <span class="item-name">{{$t('Reports')}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('marketing_settings')">
            <router-link class to="/app/marketing/settings" :class="{ open: routeIncludes('/app/marketing/settings') }">
              <lucide-icon class="nav-icon" name="settings" />
        ...
        >
          ...
          >
            <router-link class to="/app/People/Customers" :class="{ open: routeIncludes('/app/People/Customers') }">
              <lucide-icon class="nav-icon" name="shield-check" />
          ...
          >
            <router-link class to="/app/People/Customers/create" :class="{ open: routeIncludes('/app/People/Customers/create') }">
          ...
          >
            <router-link class to="/app/People/Customers_import" :class="{ open: routeIncludes('/app/People/Customers_import') }">
              <lucide-icon class="nav-icon" name="download" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('Customers_view')"
          >
            <router-link class to="/app/People/Customers_without_ecommerce" :class="{ open: routeIncludes('/app/People/Customers_without_ecommerce') }">
              <lucide-icon class="nav-icon" name="shield-check" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('Customers_view')"
          >
            <router-link class to="/app/People/Customers_ecommerce" :class="{ open: routeIncludes('/app/People/Customers_ecommerce') }">
              <lucide-icon class="nav-icon" name="shield-check" />
          ...
          >
            <router-link class to="/app/People/Suppliers" :class="{ open: routeIncludes('/app/People/Suppliers') }">
              <lucide-icon class="nav-icon" name="shield-check" />
          ...
          >
            <router-link class to="/app/People/Suppliers/create" :class="{ open: routeIncludes('/app/People/Suppliers/create') }">
              <lucide-icon class="nav-icon" name="plus" />
          ...
          >
            <router-link class to="/app/People/Suppliers_import" :class="{ open: routeIncludes('/app/People/Suppliers_import') }">
              <lucide-icon class="nav-icon" name="download" />
        ...
        >
          ...
          >
            <router-link class to="/app/User_Management/Users" :class="{ open: routeIncludes('/app/User_Management/Users') }">
              <lucide-icon class="nav-icon" name="shield-check" />
          ...
          >
            <router-link class to="/app/User_Management/permissions" :class="{ open: routeIncludes('/app/User_Management/permissions') }">
        ...
        >
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('setting_system')"
          >
            <router-link class to="/app/settings/System_settings" :class="{ open: routeIncludes('/app/settings/System_settings') }">
              <lucide-icon class="nav-icon" name="settings" />
...
<li
          ...
          >
            <router-link class to="/app/settings/zatca_settings" :class="{ open: routeIncludes('/app/settings/zatca_settings') }">
              <lucide-icon class="nav-icon" name="qr-code" />
              <span class="item-name">ZATCA E-Invoicing</span>
            </router-link>
          </li>

          <li
            class="nav-item"
            v-if="planFeature('quickbooks') && currentUserPermissions && currentUserPermissions.includes('quickbooks_settings')"
          >
            <router-link class to="/app/settings/quickbooks_sync" :class="{ open: routeIncludes('/app/settings/quickbooks_sync') }">
              <lucide-icon class="nav-icon" name="banknote" />
          ...
          >
            <router-link class to="/app/settings/appearance_settings" :class="{ open: routeIncludes('/app/settings/appearance_settings') }">
              <lucide-icon class="nav-icon" name="database-zap" />
          ...
          >
            <router-link class to="/app/settings/translations_settings" :class="{ open: routeIncludes('/app/settings/translations_settings') }">
              <lucide-icon class="nav-icon" name="database-zap" />
          ...
          >
            <router-link class to="/app/settings/payment_methods" :class="{ open: routeIncludes('/app/settings/payment_methods') }">
              <lucide-icon class="nav-icon" name="banknote" />
          ...
          >
            <router-link class to="/app/settings/sms_settings" :class="{ open: routeIncludes('/app/settings/sms_settings') }">
              <lucide-icon class="nav-icon" name="message-square" />
          ...
          >
            <router-link class to="/app/settings/sms_templates" :class="{ open: routeIncludes('/app/settings/sms_templates') }">
              <lucide-icon class="nav-icon" name="message-square" />
              <span class="item-name">{{$t('sms_templates')}}</span>
            </router-link>
          </li>
          ...
          >
            <router-link class to="/app/settings/mail_settings" :class="{ open: routeIncludes('/app/settings/mail_settings') }">
              <lucide-icon class="nav-icon" name="mail" />
           ...
           <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('notification_template')"
          >
            <router-link class to="/app/settings/email_templates" :class="{ open: routeIncludes('/app/settings/email_templates') }">
              <lucide-icon class="nav-icon" name="mail" />
              <span class="item-name">{{$t('email_templates')}}</span>
            </router-link>
          </li>
          ...
          >
            <router-link class to="/app/settings/pos_settings" :class="{ open: routeIncludes('/app/settings/pos_settings') }">
              <lucide-icon class="nav-icon" name="database-zap" />
          ...
          <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('pos_settings')"
          >
            <router-link class to="/app/settings/pos_receipt" :class="{ open: routeIncludes('/app/settings/pos_receipt') }">
          ...
          >
            <router-link class to="/app/settings/payment_gateway" :class="{ open: routeIncludes('/app/settings/payment_gateway') }">
              <lucide-icon class="nav-icon" name="banknote" />
          ...
          >
            <router-link class to="/app/settings/Warehouses" :class="{ open: routeIncludes('/app/settings/Warehouses') }">
              <lucide-icon class="nav-icon" name="store" />
          ...
          >
            <router-link class to="/app/settings/Cash_Drawers" :class="{ open: routeIncludes('/app/settings/Cash_Drawers') }">
              <lucide-icon class="nav-icon" name="wallet" />
          ...
          >
            <router-link class to="/app/settings/Warehouse_Locations" :class="{ open: routeIncludes('/app/settings/Warehouse_Locations') }">
              <lucide-icon class="nav-icon" name="map-pin" />
          ...
          >
            <router-link class to="/app/settings/Currencies" :class="{ open: routeIncludes('/app/settings/Currencies') }">
              <lucide-icon class="nav-icon" name="dollar-sign" />
          ...
          >
            <router-link class to="/app/settings/Backup" :class="{ open: routeIncludes('/app/settings/Backup') }">
          ...
          >
            <router-link class to="/app/settings/system_health" :class="{ open: routeIncludes('/app/settings/system_health') }">
          ...
          <li
            class="nav-item"
            v-if="planFeature('webhooks') && currentUserPermissions && currentUserPermissions.includes('webhooks_view')"
          >
            <router-link class to="/app/settings/webhooks" :class="{ open: routeIncludes('/app/settings/webhooks') }">
          ...
          >
            <router-link class to="/app/settings/login_devices" :class="{ open: routeIncludes('/app/settings/login_devices') }">
        ...
        >
          <li class="nav-item">
            <router-link class="nav-item-hold" to="/app/billing/current-plan" :class="{ open: routeIncludes('/app/billing/current-plan') }">
              <lucide-icon class="nav-icon" name="id-card" />
              <span class="item-name">{{ $t('Current_Plan') || 'Current Plan' }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-item-hold" to="/app/billing/change-plan" :class="{ open: routeIncludes('/app/billing/change-plan') }">
              <lucide-icon class="nav-icon" name="arrow-up-circle" />
              <span class="item-name">{{ $t('Change_Plan') || 'Change Plan' }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-item-hold" to="/app/billing/history" :class="{ open: routeIncludes('/app/billing/history') }">
        ...
        >
          <li
            ...
            class="nav-item"
          >
            <router-link class to="/app/reports/sales-3d-dashboard" :class="{ open: routeIncludes('/app/reports/sales-3d-dashboard') }">
          ...
          >
            ...
            <ul class="submenu">
              ...
              >
                <router-link class to="/app/reports/payments_purchase" :class="{ open: routeIncludes('/app/reports/payments_purchase') }">
                  <lucide-icon class="nav-icon" name="id-card" />
              ...
              >
                <router-link class to="/app/reports/payments_sale" :class="{ open: routeIncludes('/app/reports/payments_sale') }">
                  <lucide-icon class="nav-icon" name="id-card" />
              ...
              >
                <router-link class to="/app/reports/payments_sales_returns" :class="{ open: routeIncludes('/app/reports/payments_sales_returns') }">
                  <lucide-icon class="nav-icon" name="id-card" />
              ...
              >
                <router-link class to="/app/reports/payments_purchases_returns" :class="{ open: routeIncludes('/app/reports/payments_purchases_returns') }">
                  <lucide-icon class="nav-icon" name="id-card" />
          ...
          >
            <router-link class to="/app/reports/report_transactions" :class="{ open: routeIncludes('/app/reports/report_transactions') }">
              <lucide-icon class="nav-icon" name="dollar-sign" />
          ...
          >
            <router-link class to="/app/reports/cash_flow_report" :class="{ open: routeIncludes('/app/reports/cash_flow_report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          >
            <router-link class to="/app/reports/seller_report" :class="{ open: routeIncludes('/app/reports/seller_report') }">
              <lucide-icon class="nav-icon" name="user" />
          ...
          >
            <router-link class to="/app/reports/profit_and_loss" :class="{ open: routeIncludes('/app/reports/profit_and_loss') }">
              <lucide-icon class="nav-icon" name="wallet" />
          ...
          >
            <router-link class to="/app/reports/analytics_report" :class="{ open: routeIncludes('/app/reports/analytics_report') }">
              <lucide-icon class="nav-icon" name="bar-chart" />
          ...
          >
            <router-link class to="/app/reports/stock_inventory_valuation" :class="{ open: routeIncludes('/app/reports/stock_inventory_valuation') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          >
            <router-link class to="/app/reports/inventory_valuation_summary" :class="{ open: routeIncludes('/app/reports/inventory_valuation_summary') }">
              <lucide-icon class="nav-icon" name="pie-chart" />
          ...
          >
            <router-link class to="/app/reports/expenses_report" :class="{ open: routeIncludes('/app/reports/expenses_report') }">
          ...
          >
            <router-link class to="/app/reports/deposits_report" :class="{ open: routeIncludes('/app/reports/deposits_report') }">
              <lucide-icon class="nav-icon" name="shield" />
          ...
          >
            <router-link class to="/app/reports/quantity_alerts" :class="{ open: routeIncludes('/app/reports/quantity_alerts') }">
          ...
          >
            <router-link class to="/app/reports/warehouse_report" :class="{ open: routeIncludes('/app/reports/warehouse_report') }">
          ...
          >
            <router-link class to="/app/reports/internal_location_report" :class="{ open: routeIncludes('/app/reports/internal_location_report') }">
              <lucide-icon class="nav-icon" name="map-pin" />
          ...
          >
            <router-link class to="/app/reports/stock_report" :class="{ open: routeIncludes('/app/reports/stock_report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
            <router-link class to="/app/reports/serial_available_report" :class="{ open: routeIncludes('/app/reports/serial_available_report') }">
              <lucide-icon class="nav-icon" name="scan-barcode" />
              <span class="item-name">{{$t('Available_Serial_Numbers') || 'Available Serials'}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
            <router-link class to="/app/reports/serial_sold_report" :class="{ open: routeIncludes('/app/reports/serial_sold_report') }">
              <lucide-icon class="nav-icon" name="scan-barcode" />
              <span class="item-name">{{$t('Sold_Serial_Numbers') || 'Sold Serials'}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
            <router-link class to="/app/reports/serial_movement_report" :class="{ open: routeIncludes('/app/reports/serial_movement_report') }">
              <lucide-icon class="nav-icon" name="history" />
              <span class="item-name">{{$t('Serial_Movement_Log') || 'Serial Movements'}}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('serial_numbers_report')">
            <router-link class to="/app/reports/serial_inventory_report" :class="{ open: routeIncludes('/app/reports/serial_inventory_report') }">
          ...
          >
            <router-link class to="/app/reports/negative_stock_report" :class="{ open: routeIncludes('/app/reports/negative_stock_report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          >
            <router-link class to="/app/reports/product_report" :class="{ open: routeIncludes('/app/reports/product_report') }">
              <lucide-icon class="nav-icon" name="barcode" />
      ...
      <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('customer_loyalty_points_report')">
        ...
        <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('draft_invoices_report')">
          ...
          >
            <router-link class to="/app/reports/return_ratio_report" :class="{ open: routeIncludes('/app/reports/return_ratio_report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          >
            <router-link class to="/app/reports/sales_report" :class="{ open: routeIncludes('/app/reports/sales_report') }">
              <lucide-icon class="nav-icon" name="bar-chart" />
          ...
          >
            <router-link class to="/app/reports/product_sales_report" :class="{ open: routeIncludes('/app/reports/product_sales_report') }">
              <lucide-icon class="nav-icon" name="trending-up" />
          ...
          >
            <router-link class to="/app/reports/report_sales_by_category" :class="{ open: routeIncludes('/app/reports/report_sales_by_category') }">
              <lucide-icon class="nav-icon" name="tag" />
          ...
          >
            <router-link class to="/app/reports/report_sales_by_brand" :class="{ open: routeIncludes('/app/reports/report_sales_by_brand') }">
              <lucide-icon class="nav-icon" name="store" />
          ...
          >
            <router-link class to="/app/reports/purchase_report" :class="{ open: routeIncludes('/app/reports/purchase_report') }">
              <lucide-icon class="nav-icon" name="shopping-cart" />
          ...
          >
            <router-link class to="/app/reports/product_purchases_report" :class="{ open: routeIncludes('/app/reports/product_purchases_report') }">
              <lucide-icon class="nav-icon" name="shopping-basket" />
          ...
          >
            <router-link class to="/app/reports/customers_report" :class="{ open: routeIncludes('/app/reports/customers_report') }">
              <lucide-icon class="nav-icon" name="user" />
          ...
          >
            <router-link class to="/app/reports/inactive_customers" :class="{ open: routeIncludes('/app/reports/inactive_customers') }">
          ...
          >
            <router-link class to="/app/reports/providers_report" :class="{ open: routeIncludes('/app/reports/providers_report') }">
              <lucide-icon class="nav-icon" name="user" />
          ...
          >
            <router-link class to="/app/reports/top_selling_products" :class="{ open: routeIncludes('/app/reports/top_selling_products') }">
          ...
          >
            <router-link class to="/app/reports/top_customers" :class="{ open: routeIncludes('/app/reports/top_customers') }">
              <lucide-icon class="nav-icon" name="trophy" />
          ...
          >
            <router-link class to="/app/reports/users_report" :class="{ open: routeIncludes('/app/reports/users_report') }">
              <lucide-icon class="nav-icon" name="user" />
          ...
          >
            <router-link class to="/app/reports/login_activity_report" :class="{ open: routeIncludes('/app/reports/login_activity_report') }">
              <lucide-icon class="nav-icon" name="lock" />
          ...
          >
            <router-link class to="/app/reports/report_error_logs" :class="{ open: routeIncludes('/app/reports/report_error_logs') }">
...
export default {
  ...
  methods: {
    // Vue Router 3 marcaba como activo (`linkActiveClass: "open"`) todo enlace cuya ruta fuera prefijo de la ruta actual;
    // Vue Router 4 solo lo hace si el enlace es un registro padre. Se conserva la regla de Router 3 en este layout, donde
    // `a.open` tiene estilo (config.js: `.sidebar-left-secondary .childNav a.open`).
    routeIncludes(target) {
      const withSlash = (p) => p.replace(/\/*$/, "/");
      return withSlash(this.$route.path).indexOf(withSlash(target)) === 0;
    },
    ...mapActions([
