        ...
        <ul class="nav-list">
          ...
          >
            <router-link to="/app/promotions" class="nav-link">
              ...
              <span class="nav-text" v-if="!isCollapsed">{{ $t('Promotions') || 'Promotions' }}</span>
            </router-link>
          </li>
          ...
          <!-- Quotations -->
          <li
            v-show="planFeature('quotations') && currentUserPermissions && (
          ...
          <!-- Recruit -->
          <li
            v-show="planFeature('recruitment') && currentUserPermissions && (
          ...
          <!-- Meeting Management -->
          <li
            v-show="planFeature('meetings') && currentUserPermissions && (
          ...
          <li
            v-show="planFeature('marketing') && currentUserPermissions && (
          ...
          >
           ...
           <!-- shopify_settings -->
           <li
           v-if="planFeature('shopify') && currentUserPermissions && currentUserPermissions.includes('shopify_settings')"
            :class="{ active: isActiveRoute('shopify_settings') }"
            class="nav-item"
          >
            <router-link to="/app/shopify" class="nav-link">
              <lucide-icon class="nav-icon" name="store" />
              <span class="nav-text" v-if="!isCollapsed">{{ $t("Shopify_Settings") }}</span>
            </router-link>
          </li>
          ...
          >
            ...
            <ul class="submenu" v-if="openMenus.includes('settings') && !isCollapsed">
              ...
              <li class="submenu-item" v-if="planFeature('quickbooks') && currentUserPermissions && currentUserPermissions.includes('quickbooks_settings')">
              ...
              <li class="submenu-item" v-if="planFeature('webhooks') && currentUserPermissions && currentUserPermissions.includes('webhooks_view')">
