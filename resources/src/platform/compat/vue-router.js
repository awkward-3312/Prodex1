...
// `plugins`: otros plugins de app de Vue 3 (Unhead) que también deben instalarse en la app real antes de montar.
export function mountWithRouter(options, router, el, plugins = []) {
