...
const baseRoutes = [
    {
        ...
        children: [
            ...
            // Promotions & Discounts
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "promotions" */ "./views/app/pages/promotions"
                    )
            },
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "promotion_form" */ "./views/app/pages/promotions/form"
                    )
            },
            {
                name: "promotion_edit",
                path: "/app/promotions/edit/:id",
                component: () =>
                    import(
                        /* webpackChunkName: "promotion_form" */ "./views/app/pages/promotions/form"
                    )
            },
            {
                ...
                path: "/app/promotions/usages",
                component: () =>
                    import(
                        /* webpackChunkName: "promotion_usages" */ "./views/app/pages/promotions/usages"
                    )
            },
            ...
            // Settings
            {
                ...
                children: [
                    ...
                    // ZATCA E-Invoicing Phase 2 (Fatoora)
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "zatca_settings" */ "./views/app/pages/settings/zatca_settings"
                            )
                    },
            ...
            // Shopify Settings (optional module)
            {
                path: "/app/shopify",
                component: () => import(
                    /* webpackChunkName: "shopify" */ "./views/app/pages/settings/ShopifySettings.vue"
                ),
                name: "shopify_settings"
            },
