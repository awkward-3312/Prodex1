        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group :label="$t('Last_Verification')">
              <b-form-input type="date" v-model="form.last_verification"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group :label="$t('Next_Validation')">
              <b-form-input type="date" v-model="form.next_validation"></b-form-input>
            </b-form-group>
          </b-col>
          <b-col md="12">
...
<script>
import { BFormGroup, BFormInput, BFormTextarea, BFormSelect, BFormInvalidFeedback, BButton, BCol, BRow } from "@/platform/bootstrap";
export default { components: { BButton, BCol, BRow, BFormGroup, BFormInput, BFormTextarea, BFormSelect, BFormInvalidFeedback },
  name: 'AssetCreate',
  data() {
    return {
      form: {
