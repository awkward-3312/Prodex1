...
<script>
import { BFormGroup, BFormInput, BFormTextarea, BFormSelect, BModal, BTable } from "@/platform/bootstrap";
import { modals, notifications } from "@/platform";
import { mapGetters } from "vuex";
import DOMPurify from "dompurify";

export default { components: { BTable, BModal, BFormGroup, BFormInput, BFormTextarea, BFormSelect },
