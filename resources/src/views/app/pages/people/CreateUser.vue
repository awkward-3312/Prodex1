    ...
    <b-card class="mb-3 border-0 shadow-sm">
      <div class="d-flex flex-wrap justify-content-between align-items-start">
        <div>
          ...
          <p class="text-muted mb-0">El rol define qué puede hacer. Las sucursales y ubicaciones de inventario definen dónde puede hacerlo. No necesitas Gestión de personal para crear usuarios.</p>
        </div>
        <b-button variant="outline-primary" class="mt-2 mt-md-0" @click="$router.push('/app/organization/role-templates')">
        ...
        <b-card class="mb-3">
          ...
          <b-row>
            ...
            <template v-if="user.scope !== 'all'">
              <b-col md="12" v-if="selectedBranchIds.length"><b-form-group label="Ubicaciones de inventario permitidas"><v-select multiple v-model="user.inventory_location_ids" :reduce="o => o.value" :options="allowedLocationOptions" placeholder="Piso de venta, Bodega, Cuarentena…"/><small class="text-muted">Cajero: normalmente Piso de venta. Bodeguero: puede incluir Bodega y otras ubicaciones según el rol.</small></b-form-group></b-col>
