              ...
              >
                <b-form-group :label="$t('password') + ' ' + '*'">
                  <div class="position-relative">
                    ...
                    <button
                      type="button"
                      class="btn btn-link p-0 position-absolute text-secondary d-inline-flex align-items-center justify-content-center"
                      style="top: 50%; right: 10px; transform: translateY(-50%); width: 1.25rem; height: 1.25rem; line-height: 1; z-index: 5;"
