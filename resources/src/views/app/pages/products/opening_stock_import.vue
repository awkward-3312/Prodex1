...
<script>
import { BAlert, BButton, BButtonGroup, BCard, BCol, BProgress, BRow } from "@/platform/bootstrap";
import { notifications } from "@/platform";
import NProgress from 'nprogress';
// axios assumed globally available

export default { components: { BAlert, BButton, BButtonGroup, BCard, BCol, BProgress, BRow },
