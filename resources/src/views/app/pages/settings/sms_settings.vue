          ...
          <b-col lg="12" md="12" sm="12">
            <b-card no-body :header="$t('Custom_SMS_Gateway')">
              <b-card-body>
                ...
                <!-- Configuration guide -->
                <h6 class="font-weight-bold">{{ $t('Custom_SMS_Guide_Title') }}</h6>
                <p class="text-muted small">{{ $t('Custom_SMS_Guide_Intro') }}</p>
                ...
                <ul class="text-muted small pl-3 mt-2">
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Api_Url') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Api_Url') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Method') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Method') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Content_Type') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Content_Type') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Sender') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Sender') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Success_Keyword') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Success_Keyword') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Headers') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Headers') }}
                  </li>
                  <li class="mb-1">
                    <strong>{{ $t('Custom_SMS_Payload') }} :</strong>
                    {{ $t('Custom_SMS_Guide_Payload') }}
                  </li>
                </ul>

                <p class="text-muted small mb-1">
                  <strong>{{ $t('Custom_SMS_Guide_Example') }} :</strong>
                </p>
                <pre class="small p-3 rounded border text-muted mb-2">POST  https://api.provider.com/sms/send      ({{ $t('Custom_SMS_Content_Type') }}: json)
...
{{ $t('Custom_SMS_Success_Keyword') }}: "status":"sent"</pre>
                ...
                <p class="text-muted small font-weight-bold mb-0">
                  <lucide-icon name="info" class="me-1" /> {{ $t('Custom_SMS_Guide_Default_Note') }}
                </p>
              </b-card-body>
            </b-card>
          </b-col>
