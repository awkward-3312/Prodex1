                    ...
                    <b-row>
                      ...
                      <b-col lg="6" md="6" sm="12" class="mb-3">
                        <b-form-group :label="$t('Accounting_Journals') || 'Accounting Journals'">
                          ...
                          <p class="text-muted small mt-2 mb-0">
                            {{ $t('Auto_Generate_Journals_Hint') || 'When enabled, journal entries are created automatically from sales, purchases, payments and expenses. When disabled, journal entries must be recorded manually.' }}
                          </p>
                        </b-form-group>
                      </b-col>
                    ...
                    <b-form-group :label="$t('Default_Payment_Method')">
                      ...
                      <b-col lg="6" md="6" sm="12" class="mb-3">
                        <b-form-group :label="$t('Add_Other_Charges') || 'Add More Shipping And Other Charge'">
                          ...
                          <p class="text-muted small mt-2 mb-0">
                            {{ $t('Enable_Purchase_Extra_Charges_Help') || 'When enabled, the purchase create/edit form shows the "Add More Shipping And Other Charge" section. Charges are added to the purchase Grand Total.' }}
                          </p>
                        </b-form-group>
                      </b-col>
                      ...
                      <b-col lg="6" md="6" sm="12" class="mb-3">
                        <b-form-group :label="$t('Additional_Fields') || 'Additional Fields (Weight / Text / Number)'">
                          ...
                          <p class="text-muted small mt-2 mb-0">
                            {{ $t('Enable_Purchase_Custom_Fields_Help') || 'When enabled, the purchase create/edit form shows the "Additional Fields (Weight / Text / Number)" section. These fields are informational and do not affect totals.' }}
                          </p>
                        </b-form-group>
                      </b-col>
...
export default {
  ...
  data() {
    return {
      ...
      setting: {
        ...
        accounting_auto_generate_journals: false,
        // Purchase form section toggles (Defaults tab, off by default)
  ...
  methods: {
    ...
    Update_Settings() {
      ...
      self.data.append("accounting_auto_generate_journals", self.setting.accounting_auto_generate_journals ? 1 : 0);
      self.data.append("purchase_extra_charges_enabled", self.setting.purchase_extra_charges_enabled ? 1 : 0);
      self.data.append("purchase_custom_fields_enabled", self.setting.purchase_custom_fields_enabled ? 1 : 0);
