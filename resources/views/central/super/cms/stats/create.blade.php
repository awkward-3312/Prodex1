        ...
        <form method="POST" action="{{ route('super.cms.stats.store') }}">
            ...
            <div class="form-row mb-4">
                <div class="form-group">
                    ...
                    <input type="text" name="value" class="form-control" value="{{ old('value') }}" placeholder="Ej.: 10 mil+" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="label" class="form-control" value="{{ old('label') }}" placeholder="Ej.: Empresas" required>
                </div>
            </div>
            <div class="form-row mb-4">
                <div class="form-group">
                    <label class="form-label">{{ __('super.stats.field_icon') }}</label>
                    <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="Ej.: bi bi-building">
