...
@section('title', __('central.SmsNotificationTemplates'))
...
<div class="page-header">
    <h1>{{ __('central.SmsNotificationTemplates') }}</h1>
    <p class="page-subtitle">{{ __('central.SmsTemplatesSubtitle') }}</p>
</div>
...
@if($templates->isEmpty())
    <div class="empty-state">
        ...
        <p class="text-muted">{{ __('central.RunSeederToCreateTemplates') }}<br><code>php artisan db:seed --class="Database\Seeders\Central\SmsTemplatesSeeder"</code></p>
    </div>
@else
    <div class="row g-4">
        ...
        @php
            ...
            $icon  = $triggerIcons[$tpl->trigger_key]  ?? 'bi-chat-left-dots';
            ...
            <div class="content-card template-card">
                <div class="card-body-custom">
                    ...
                    <div class="template-subject mb-3">
                        <span class="text-muted fs-xs3 fw-600">{{ __('central.SmsMessage') }}:</span>
                        <span class="fs-sm4">{{ \Illuminate\Support\Str::limit($tpl->body, 120) }}</span>
                    </div>

                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        <a href="{{ route('super.sms-templates.edit', $tpl) }}" class="btn btn-primary btn-sm">
    ...
    <div class="content-card mt-4">
        ...
        <div class="card-body-custom">
            ...
            <div class="row g-2">
                @foreach(\App\Models\Central\SmsTemplate::AVAILABLE_VARIABLES as $var => $desc)
