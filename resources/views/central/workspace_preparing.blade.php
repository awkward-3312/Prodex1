...
<div class="prep-card">
    <div class="prep-banner">
        ...
        <div class="banner-content">
            <a class="brand-logo" href="{{ route('central.welcome') }}">
                <div class="logo-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
                </div>
    ...
    <div class="prep-body">
        ...
        <div class="status-box" id="statusBox">
            ...
            <div class="status-icon icon-success" id="successIcon"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
            <div class="status-icon icon-fail" id="failIcon"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></div>
        ...
        <ul class="steps" id="stepList">
            <li id="step-payment"><span class="step-bullet"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><span class="dot"></span></span><span>{{ __('central.StepPaymentVerification') }}</span></li>
            <li id="step-tenant"><span class="step-bullet"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><span class="dot"></span></span><span>{{ __('central.StepCreatingWorkspace') }}</span></li>
            <li id="step-db"><span class="step-bullet"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><span class="dot"></span></span><span>{{ __('central.StepSettingUpDatabase') }}</span></li>
            <li id="step-ready"><span class="step-bullet"><svg viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg><span class="dot"></span></span><span>{{ __('central.StepWorkspaceReady') }}</span></li>
        </ul>

        <div class="error-alert" id="errorBox"></div>
        <div class="action-buttons" id="actionButtons">
            <button class="btn-retry" id="retryBtn"><svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>{{ __('central.TryAgain') }}</button>
            <a href="mailto:support@{{ request()->getHost() }}" class="btn-support"><svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>{{ __('central.ContactSupport') }}</a>
        </div>
